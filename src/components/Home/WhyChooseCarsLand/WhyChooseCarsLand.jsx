            ...
            <div className="row">
              <div className="col-10 col-sm-6 col-md-4 col-lg-3 mx-auto shadow p-3">
                ...
                <p className="text-center text-muted">
                  ...
                  from all brands, so you can find the vehicles that capture
              ...
              <div className="col-10 col-sm-6 col-md-4 col-lg-3 mx-auto shadow p-3">
                ...
                <p className="text-center text-muted">
                  We believe that the joy of collecting and playing with toy
                  cars should be accessible to everyone. That's why we are
                  committed to offering a wide range of affordable options.
                </p>
              </div>
              ...
              <div className="col-10 col-sm-6 col-md-4 col-lg-3 mx-auto shadow p-3">
                ...
                <p className="text-center text-muted">
                  ...
                  experience from start to finish. With our fast delivery
                  service, you can look forward to receiving your toy.
                </p>
              </div>
            </div>
          </div>
